...
```{r load_raster, message = FALSE, title = '{{ site.handouts[0] }}'}
library(raster)
...
```{r crop_raster, fig.keep="last", title="{{ site.handouts[0] }}"}
...
```{r lc_types, title="{{ site.handouts[0] }}"}
...
```{r mask, fig.keep="last", title="{{ site.handouts[0] }}"}
...
```{r agg_raster, fig.keep="last", title="{{ site.handouts[0] }}"}
