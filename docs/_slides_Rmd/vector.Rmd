...
```{r create_point, title="{{ site.handouts }}"}
...
```{r subset_md, title="{{ site.handouts }}"}
...
```{r gUnion, message=FALSE, result='hide',  title="{{ site.handouts }}"}
library(rgeos)
...
```{r gIntersect, title="{{ site.handouts }}"}
