...
```{r load_raster, message = FALSE, handout = 0}
library(raster)
...
```{r crop_raster, fig.keep="last", handout = 0}
...
```{r mask, fig.keep="last", handout = 0}
...
```{r agg_raster, fig.keep="last", handout = 0}
